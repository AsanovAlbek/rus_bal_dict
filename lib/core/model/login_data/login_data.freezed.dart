...
abstract class $LoginDataCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: 'rememberMe') bool rememberMe});
}
...
class _$LoginDataImpl implements _LoginData {
  const _$LoginDataImpl(
      ...
      @JsonKey(name: 'rememberMe') this.rememberMe = false});
  ...
  @override
  String toString() {
    return 'LoginData(email: $email, password: $password, rememberMe: $rememberMe)';
  }
...
abstract class _LoginData implements LoginData {
  const factory _LoginData(
      ...
      @JsonKey(name: 'rememberMe') final bool rememberMe}) = _$LoginDataImpl;
