...
extension WordToHive on Word {
  WordHiveModel toHive(int userId) => WordHiveModel(id: id ?? 0, word: word, meaning: meaning, audioUrl: audioUrl, createTime: DateTime.now().microsecondsSinceEpoch, userId: userId);
}
