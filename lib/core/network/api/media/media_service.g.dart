...
class _MediaService implements MediaService {
  ...
  Future<UploadFileResponse> uploadFile(File file) async {
    ...
    final _options = _setStreamType<UploadFileResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
  ...
  Future<DeleteFileResponse> deleteFile(String filePath) async {
    ...
    final _options = _setStreamType<DeleteFileResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<GetFileResponse> getFile(String filePath) async {
    ...
    final _options = _setStreamType<GetFileResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
